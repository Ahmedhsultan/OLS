...
namespace OLS.Services.OLSes
{
    public class TakeOff_OLS
    {
        ...
        public TakeOff_OLS(TakeOffAttriputes takeOffAttriputes, double RunWayWidth, Point3d startPoint, Vector3d vector3D, Vector3d prependicularVector)
        {
        ...
        public void CreateSurface(CivilDocument _civildoc, Transaction trans)
        {
            ...
            ObjectId styleId = _civildoc.Styles.SurfaceStyles["Slope Banding (2D)"];
